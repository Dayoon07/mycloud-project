                ...
                <c:otherwise>
                	...
                	<c:if test="${ not empty chkMymsg }">
	                	<c:forEach var="cmm" items="${ chkMymsg }">
	                		<div style="font-size: 14px;" onclick="fuckCorsConfig(${ cmm.msgId })" class="block flex justify-between lg:items-center px-4 py-2 text-md border-b cursor-pointer hover:bg-gray-100">
